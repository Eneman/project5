 ...
 */
final class Version20190722132427 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE stb DROP players');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE stb ADD players JSON NOT NULL COLLATE utf8mb4_bin COMMENT \'(DC2Type:json_array)\'');
